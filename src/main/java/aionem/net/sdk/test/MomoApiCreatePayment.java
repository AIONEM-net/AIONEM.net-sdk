...
public class MomoApiCreatePayment {
    ...
    public static void main(String[] args) {
        ...
        momoApiCreatePayment(bearerToken, x_Reference_Id);

    }

    public static void momoApiCreatePayment(String bearerToken, String x_Reference_Id) {
        ...
        try {
            ...
            String link = baseUrl + "/collection/v2_0/payment";
