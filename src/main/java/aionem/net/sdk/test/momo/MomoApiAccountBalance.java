...
public class MomoApiAccountBalance {
    ...
    public static void momoApiAccountBalance(String bearerToken, String currency) {
        ...
        try {
            ...
            String link = baseUrl + "/account/balance"+ (currency != null && !currency.isEmpty() ? "/" + currency : "");
