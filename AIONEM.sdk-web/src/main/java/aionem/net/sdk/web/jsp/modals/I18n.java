...
public class I18n {
    ...
    public I18n(final String baseName, final JspProperties properties) {
        this(baseName, null, properties.getData());
    }
    public I18n(final String baseName, final I18n i18n) {
        init(baseName, i18n);
    }
    public I18n(final String baseName, final Locale locale, final JspProperties properties) {
    ...
    public I18n init(final String baseName, final JspProperties properties) {
    ...
    public I18n init(final String baseName, final I18n i18n, final JspProperties properties) {
        return init(baseName, i18n.getLocal(), properties);
    }
    public I18n init(final String baseName, final I18n i18n, final AioJsp aioJsp) {
        this.aioJsp = aioJsp;
        return init(baseName, i18n);
    }
    public I18n init(final String baseName, final I18n i18n, final JspProperties properties, final AioJsp aioJsp) {
        this.aioJsp = aioJsp;
        return init(baseName, i18n, properties);
    }
    public I18n init(final String baseName, final AioJsp aioJsp, final JspProperties properties) {
        return init(baseName, aioJsp.getLocale(), properties.getData());
    }
    public I18n init(final String baseName, final Locale locale, final JspProperties properties) {
    ...
    public String get(final String key, final String defaultValue, final boolean isI18n) {
        ...
        try {
            ...
            if(UtilsText.isEmpty(value)) {
                if(isI18n) {
                    if(aioJsp != null) {
                        final Object i18n = aioJsp.getApplicationAttribute("i18n");
                        if(i18n != null) {
