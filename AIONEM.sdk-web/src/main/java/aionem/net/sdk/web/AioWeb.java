...
import aionem.net.sdk.web.modals.Config;
...
public @Getter class AioWeb {
    ...
    public boolean isEnvProd() {
        return Constants.ENV_PROD.equalsIgnoreCase(getConfigEnv());
    }
    public boolean isEnvStage() {
        return Constants.ENV_STAGE.equalsIgnoreCase(getConfigEnv());
    }
    public boolean isEnvDev() {
        return Constants.ENV_DEV.equalsIgnoreCase(getConfigEnv());
    }
    public boolean isEnvLocal() {
        return Constants.ENV_LOCAL.equalsIgnoreCase(getConfigEnv());
    }
    ...
    public String readFile(final String fileName) {
        return UtilsWeb.readResourceFile(this, fileName);
    }
    ...
    public Page getPage() {
        ...
        return new Page(this, getServletPath(), new Properties(new File(filePage, "properties.json")));
    }
    public ArrayList<Page> getListPagesRoot() {
        final Page pageItem = new Page(this, "");
    ...
    public ArrayList<Page> getListPages(final Page pageParent) {
        ...
        for(final File filePage : getListFilePages(filePageParent)) {
            final String pagePath = filePage.getAbsolutePath().substring(rootPagePath.length()-1);
            final Page page = new Page(this, pagePath, new Properties(new File(filePage, "properties.json")));
    ...
    public ArrayList<Page> getListPagesAll() {
        ...
        for(final File filePage : getListFilePagesAll()) {
            final String pagePath = filePage.getAbsolutePath().substring(rootPagePath.length()-1);
            final Page page = new Page(this, pagePath);
            listPages.add(page);
        }
        return listPages;
    }
