...
public class UtilsWeb {
    ...
    public static String readEtcFile(final AioWeb aioWeb, final String fileName) {
        return readFile(aioWeb, "/WEB-INF/ui.app/etc"+ fileName);
    }
    public static String readResourceFile(final AioWeb aioWeb, final String fileName) {
        return readFile(aioWeb, "/WEB-INF/classes"+ fileName);
    }
    public static String readWebInfFile(final AioWeb aioWeb, final String fileName) {
        return readFile(aioWeb, "/WEB-INF"+ fileName);
    }

    public static String readFile(final AioWeb aioWeb, final String fileName) {
        try {
            final File file = new File(aioWeb.getRealPathRoot(fileName));
            if(!file.isDirectory()) {
    ...
    public static String readResource(final AioWeb aioWeb, final String fileName) {
        try {
            final InputStream inputStream = aioWeb.getResourceAsStream(fileName);
            if(inputStream != null) {
