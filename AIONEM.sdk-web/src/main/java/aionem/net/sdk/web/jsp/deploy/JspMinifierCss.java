...
public class JspMinifierCss {
    ...
    public static DaoRes minifySave(String pathIn, String pathOut) {
        ...
        final boolean isSaved = JspUtils.writeFile(fileOut, css);
    ...
    public static String minifyFolder(final AioJsp aioJsp, final File fileFolder, final boolean isSave) {

        final StringBuilder builderCss = new StringBuilder();

        final String uiFrontend = aioJsp.getContextPath("/ui.frontend");
        ...
        for(int i = 0; i < listFileCss.size(); i++) {
            ...
            final File file = new File(aioJsp.getRealPathRoot(listFileCss.get(i)));
        ...
        if(isSave) {
            JspUtils.writeFile(fileCss, builderCss.toString());
        }
        ...
        if(isSave) {
            ...
            final ArrayList<File> listFiles = JspUtils.findFiles(fileFolder, filterCss);
